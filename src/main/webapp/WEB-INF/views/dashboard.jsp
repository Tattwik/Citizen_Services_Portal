...
<body>
	<%-- <label for="userName">WELCOME ${userName}</label> --%>
	<div class="head" style="background-color: teal;">
		<img alt="userProfilePhoto" src="images/john doe.jpg" height="70px"
			...
			class="text-primary"><label style="color: black;">Apply Birth Certificate</label></a> <a href="view"
			style="text-decoration: none; font-size: x-large; font-family: sans-serif; margin-left: 120px; color: black;"
			class="text-primary"><label style="color: black;">View Birth Certificate Application Status</label></a> <button
			onclick="logout()"
